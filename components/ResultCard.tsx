  ...
  return (
    <div className={`w-full max-w-4xl mx-auto transition-opacity duration-1000 ${showContent ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="mt-8 text-center mb-8">
        <button
          onClick={onReset}
          className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-white border border-stone-200 text-stone-600 font-medium hover:bg-stone-50 hover:text-amber-600 transition-colors shadow-sm text-sm"
        >
          <RefreshCw size={16} />
          查詢其他日期或城市
        </button>
